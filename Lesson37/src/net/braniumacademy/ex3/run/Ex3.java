package net.braniumacademy.ex3.run;

import net.braniumacademy.ex3.*;
 ...
 * @website: <a href="https://braniumacademy.net">Trang chủ</a>
 */

public class Ex3 {
    private static final String subjectFileName = "SUB.DAT";
    private static final String studentFileName = "STUD.DAT";
    private static final String courseFileName = "COU.DAT";
    private static final String transcriptFileName = "TRAN.DAT";
    private static final String tosFileName = "COU-TRAN.DAT";
        ...
        do {
            ...
            switch (choice) {
                case 0 -> {
                    ...
                    showMessage(" PROJECT CỦA BRANIUM ACADEMY   ");
                    showMessage("===============================");
                }
                case 1 -> {
                ...
                case 5 -> showSubjects(subjects);
                case 6 -> showStudents(students);
                case 7 -> showCourses(courses);
                case 8 -> {
                    if (courses.size() > 0) {
                ...
                default -> showMessage("Sai chức năng, vui lòng chọn lại!");
            }
        } while (choice != 0);
    }
    ...
    private static void fillCourseInfo(ArrayList<Course> courses,
        ...
        for (Course course : courses) {
            ...
            for (Course.TranscriptOfStudent item : tosList) {
    ...
    private static void saveTOSListToFile(
            ArrayList<Course.TranscriptOfStudent> tosList,
     ...
     */
    private static void saveTranscriptsToFile(ArrayList<Transcript> transcripts) {
    ...
    private static ArrayList<Course.TranscriptOfStudent> readTOSFromFile(
        ...
        try {
            ...
            while (input.hasNextLine()) {
                ...
                Course.TranscriptOfStudent tos = null;
                if (course != null) {
                    tos = course.new TranscriptOfStudent(student, tran,
                            courseId);
                }
                tosList.add(tos);
            }
     ...
     */
    private static void fillGrades(Transcript tran) {
        var input = new Scanner(System.in);
    ...
    private static Course findCourseById(ArrayList<Course> courses, String courseId) {
        for (Course cours : courses) {
            if (cours.getId().compareTo(courseId) == 0) {
                return cours;
            }
        }
        return null;
     ...
     *
     * @param course khóa học cần hiển thị
     */
    ...
    private static Student createNewStudent(Scanner input) {
        ...
        return new Student(null, fullName, address,
